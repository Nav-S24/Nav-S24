...
# ===========================================================================
HOST = "nav-s24"   # shown as  nav-s24@github  in the header

ROWS = [
    ("host",),
    ("kv", "Name", "Navya Saxena"),
    ("kv", "Focus", "Learning by building."),
    ("kv", "LinkedIn", "navya-saxena07"),
    ("kv", "LeetCode", "NavyaS_07"),
    ("gap",),
    ("sec", "Languages"),
    ("kv", "", "Java, Python, SQL, JavaScript, C++, HTML5,"),
    ("kv", "", "CSS3"),
    ("sec", "Backend"),
    ("kv", "", "Spring Boot, Spring Framework, Spring Data"),
    ("kv", "", "JPA, Hibernate, REST APIs"),
    ("sec", "Frontend"),
    ("kv", "", "React, Bootstrap, Tailwind CSS"),
    ("sec", "Databases"),
    ("kv", "", "MySQL, MongoDB, Firebase Firestore"),
    ("sec", "AI / ML"),
    ("kv", "", "Matplotlib, Scikit-learn, NLP, TensorFlow,"),
    ("kv", "", "RAG"),
    ("sec", "Tools & Platforms"),
    ("kv", "", "Git, GitHub, IntelliJ IDEA, VS Code,"),
    ("kv", "", "Postman, Maven, Firebase, Google Cloud"),
]
